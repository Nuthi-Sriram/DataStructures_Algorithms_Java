		...
		do {
			...
			case 1: {
				...
				while (n != 0) {
					...
					System.out.println("Enter the " + i + " value  which you want to enter into the list");
					int x = sc.nextInt();
			...
			case 6: {
				...
				x = b.search(root, y);
				if (x == 1)
					System.out.println("The given element is present in the tree");
				else
					System.out.println("The given element is not present in the tree");
			}
				break;
			case 7: {
